<template>
                    ...
                    <td class="text-center">
                        <div v-if="!currentUser.isGuest()" class="flex items-center justify-center gap-2">
                            ...
                            <el-popconfirm title="确认删除?"
                                @confirm="() => warehouseSettings.deleteById(row.id!).then(() => fetchData())">
                                <template #reference>
    ...
    <UpdateDialog :settings="current!" :dialog-visible="updateDialog" @refresh="fetchData"
...
const current = ref<type_WarehouseSettings>()
