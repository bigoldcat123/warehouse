            ...
            <el-table-column prop="yuntu" label="云图" width="80">
                <template #default="scope">
                    <el-button type="primary" size="small"
                        @click="() => $router.push({ path: '/show', query: { imgs: scope.row.yuntu, lx: 'img' } })">查看</el-button>
                </template>
            </el-table-column>
            <el-table-column prop="yuntu" label="曲线" width="80">
                <template #default="scope">
                    <el-button type="primary" size="small"
                        @click="() => $router.push({ path: '/show', query: { imgs: scope.row.quxian, lx: 'line' } })">查看</el-button>
                </template>
            </el-table-column>
            <el-table-column prop="threeD" label="3D图" width="80">
                <template #default="scope">
                    <el-button type="primary" size="small"
                        @click="() => $router.push({ path: '/show', query: { imgs: scope.row.threeD, lx: 'threeD' } })">查看</el-button>
                </template>
            </el-table-column>

            <el-table-column prop="valeWin" label="水势图" width="80">
                <template #default="scope">
                    <el-button type="primary" size="small"
                        @click="() => $router.push({ path: '/show', query: { imgs: scope.row.valeWin, lx: 'valeWin' } })">查看</el-button>
                </template>
            </el-table-column>
